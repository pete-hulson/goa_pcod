...
source(here::here(new_SS_dat_year, "R", "get_data", "BIN_LEN_DATA.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "cond_length_age_corFISH.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "conditional_Length_AGE_cor.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "find_ALF.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "FISH_AGE_COMP.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "FORMAT_AGE_MEANS1.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "GET_DOM_AGE.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "GET_GOA_ACOMP1.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "GET_GOA_BIOM.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "GET_GOA_LCOMP1.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "GET_GOA_LENCOM2.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "GET_GOA_LL_RPN.r"))
source(here::here(new_SS_dat_year, "R", "get_data", "GET_LENGTH_BY_CATCH_GOA.R"))
source(here::here(new_SS_dat_year, "R", "get_data", "GET_SURV_AGE_cor.r"))
