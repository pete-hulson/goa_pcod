...
Do_AK_Scenarios<-function(DIR="C:/WORKING_FOLDER/Model19.14.48c_T",CYR=2020,SYR=1977,FCASTY=15,SEXES=1,FLEETS=c(1:3),Scenario2=1,S2_F=0.4,do_fig=TRUE){
...
## Examples
## profiles<-Do_AK_Scenarios(DIR="C:/WORKING_FOLDER/Model19.14.48c_T_newdata",CYR=2019,SYR=1977,FCASTY=16,SEXES=1,FLEETS=c(1:3),Scenario2=1,S2_F=0.4,do_fig=TRUE)
