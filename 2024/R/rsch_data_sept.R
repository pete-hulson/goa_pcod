...
dat_orig$agecomp[dat_orig$agecomp$fleet <= 3, 'Nsamp'] = dat$agecomp[dat$agecomp$fleet <= 3, 'Nsamp']
r4ss::SS_writedat_3.30(dat_orig,
...
dat_orig$N_lbins = dat$lbin_vector
...
r4ss::SS_lencompr4ss::SS_writedat_3.30(dat_orig,
