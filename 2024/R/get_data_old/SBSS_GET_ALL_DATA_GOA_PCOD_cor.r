                              ...
                              AUXFCOMP = 3)
{
  ...
  vroom::vroom_write(CATCH, here::here(new_year, 'data_old', 'raw', 'catch.csv'), delim = ",")
  ...
  if(inc_ADFG == TRUE){
    ...
    vroom::vroom_write(ADFG_CATCH, here::here(new_year, 'data_old', 'raw', 'adfg_catch.csv'), delim = ",")
  ...
  if(exists("ADFG_IPHC")){ 
    ...
    if(update_adfg_iphc == TRUE){
      ...
      IPHC <- sqlQuery(CHINA, query = ("
        ...
        vroom::vroom_write(., here::here(new_year, 'data_old', 'raw', 'iphc_ll.csv'), delim = ",")
      ...
      vroom::vroom_write(adfg_iphc, here::here(new_year, 'data_old', 'ADFG_IPHC_updated.csv'), delim = ",")
