...
#C file write time: 2024-08-28 14:27:31.893963
#
...
1965.93354395234 #_last_yr_nobias_adj_in_MPD; begin of ramp
1988.55198666588 #_first_yr_fullbias_adj_in_MPD; begin of plateau
2019.60779461021 #_last_yr_fullbias_adj_in_MPD
2028.86621950734 #_end_yr_for_ramp_in_MPD (can be in forecast to shape ramp, but SS sets bias_adj to 0.0 for fcast yrs)
0.889497700792428 #_max_bias_adj_in_MPD (-1 to override ramp and set biasadj=1.0 for all estimated recdevs)
...
#_SizeSelex
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env-var	use_dev	dev_mnyr	dev_mxyr	dev_PH	Block	Blk_Fxn  #  parm_name
   10	    100	  57.6551	 50	0	0	 1	0	1	1977	2024	3	0	0	#_SizeSel_P_1_FshTrawl(1)
  -20	     10	 -4.57915	  0	0	0	 2	0	0	1977	2024	0	0	0	#_SizeSel_P_2_FshTrawl(1)
  -10	     10	  5.09148	  0	0	0	 2	0	1	1977	2024	3	0	0	#_SizeSel_P_3_FshTrawl(1)
  -10	     10	-0.301675	 10	0	0	 2	0	1	1977	2024	3	0	0	#_SizeSel_P_4_FshTrawl(1)
-1000	2.71828	     -999	-10	0	0	-2	0	0	   0	   0	0	0	0	#_SizeSel_P_5_FshTrawl(1)
  -10	     10	       10	 10	0	0	-2	0	0	   0	   0	0	0	0	#_SizeSel_P_6_FshTrawl(1)
   10	     90	  66.4253	 50	0	0	 1	0	1	1978	2024	3	0	0	#_SizeSel_P_1_FshLL(2)   
  -20	     10	 -5.06337	  0	0	0	 2	0	0	1978	2024	0	0	0	#_SizeSel_P_2_FshLL(2)   
  -10	     10	  5.14687	  0	0	0	 2	0	1	1978	2024	3	0	0	#_SizeSel_P_3_FshLL(2)   
    0	     10	       10	 10	0	0	-2	0	0	   0	   0	0	0	0	#_SizeSel_P_4_FshLL(2)   
-1000	2.71828	     -999	-10	0	0	-2	0	0	   0	   0	0	0	0	#_SizeSel_P_5_FshLL(2)   
  -10	     10	       10	 10	0	0	-2	0	0	   0	   0	0	0	0	#_SizeSel_P_6_FshLL(2)   
   10	     90	  70.7282	 50	0	0	 1	0	1	1991	2024	3	0	0	#_SizeSel_P_1_FshPot(3)  
  -20	     10	 -12.0643	  0	0	0	 2	0	0	   0	   0	0	0	0	#_SizeSel_P_2_FshPot(3)  
  -10	     10	  5.01625	  0	0	0	 2	0	1	1991	2024	3	0	0	#_SizeSel_P_3_FshPot(3)  
    0	     10	   4.0558	 10	0	0	 2	0	0	   0	   0	0	0	0	#_SizeSel_P_4_FshPot(3)  
-1000	2.71828	     -999	-10	0	0	-2	0	0	   0	   0	0	0	0	#_SizeSel_P_5_FshPot(3)  
  -10	     10	 0.284913	 10	0	0	 2	0	1	1991	2024	3	0	0	#_SizeSel_P_6_FshPot(3)  
...
1e-04	   2	0.2	0.2	0.5	6	-5	#_SizeSel_P_1_FshPot(3)_dev_se        
-0.99	0.99	  0	  0	0.5	6	-6	#_SizeSel_P_1_FshPot(3)_dev_autocorr  
1e-04	   2	0.2	0.2	0.5	6	-5	#_SizeSel_P_3_FshPot(3)_dev_se        
-0.99	0.99	  0	  0	0.5	6	-6	#_SizeSel_P_3_FshPot(3)_dev_autocorr  
1e-04	   2	0.2	0.2	0.5	6	-5	#_SizeSel_P_6_FshPot(3)_dev_se        
-0.99	0.99	  0	  0	0.5	6	-6	#_SizeSel_P_6_FshPot(3)_dev_autocorr  
